...
impl Default for CurveConfig {
    fn default() -> Self {
        Self {
            ...
            // to ~1.2s (between a quarter and an eighth of the original
            // tempo) so the content ride reads without dragging.
